...
description: 三条学习路径 - 快速体验(30分钟) / 系统学习(8小时) / 深度掌握(30+小时)。从零开始学习大语言模型训练，适合准备大模型岗位面试的同学。
...
| [📚 系统学习](#-系统学习-8-小时) | 8 小时 | 掌握基础组件与架构组装 | 想深入理解 Transformer |
...
**目标**：完整掌握 Transformer 的基础组件与 Block 组装方式
...
#### 阶段 2：Architecture（架构组装）- 2.5 小时

**学习内容**：
- 📖 学习 [残差连接](modules/02-architecture/01-residual-connection/)（1 小时）
  - 阅读教学与代码指南
  - 运行 3 个残差连接实验
- 📖 学习 [Transformer Block](modules/02-architecture/02-transformer-block/)（1.5 小时）
  - 理解 Pre-LN Block 的数据流与组件顺序
  - 运行 3 个组件消融、顺序与因果性实验
