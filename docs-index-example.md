...
features:
  - icon: 🧱
    title: 模块化教学
    details: 4个基础组件 + 2个架构模块,每个模块包含教学文档、代码导读、实验和自测题
    link: /modules/
    linkText: 开始学习

  - icon: 🔬
    title: 对照实验验证
    details: 通过可执行实验理解每个设计选择 - "不这样做会怎样?"
    link: /modules/foundation/01-normalization/
    linkText: 查看实验

  - icon: 📝
    title: 学习日志
    details: 记录学习过程中的思考、问题和收获,建立个人知识体系
    link: /notes/learning-log
    linkText: 查看笔记

  - icon: 📚
    title: 系统化知识库
    details: 按主题整理的技术概念、公式推导和问答记录
    link: /notes/knowledge-base
    linkText: 浏览知识库
...
| 模块 | 核心问题 | 时长 | 状态 |
|------|---------|------|------|
| [归一化](/modules/foundation/01-normalization/) | 为什么需要归一化? Pre-LN vs Post-LN? | 1h | ✅ |
| [位置编码](/modules/foundation/02-position-encoding/) | 为什么选择 RoPE? 如何实现长度外推? | 1.5h | ✅ |
| [注意力机制](/modules/foundation/03-attention/) | QKV 的直觉是什么? 为什么需要多头? | 2h | ✅ |
| [前馈网络](/modules/foundation/04-feedforward/) | FFN 存储了什么知识? 为什么需要扩张? | 1h | ✅ |

### 🏗️ 架构组装 (Architecture)

| 模块 | 核心问题 | 时长 | 状态 |
|------|---------|------|------|
| [残差连接](/modules/architecture/01-residual-connection/) | 为什么需要残差连接? 如何稳定梯度流? | 1h | 📋 |
| [Transformer Block](/modules/architecture/02-transformer-block/) | 如何编排组件顺序? 为什么是这个顺序? | 1.5h | 📋 |
...
- 📝 **学习日志**: [我的学习记录](/notes/learning-log)
- 📚 **知识库**: [技术知识整理](/notes/knowledge-base)
- 💻 **代码示例**: [可执行示例](/notes/materials/)
