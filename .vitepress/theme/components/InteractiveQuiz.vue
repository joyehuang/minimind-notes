...
import { QUIZ_TRANSLATIONS } from '../constants/quiz'

const { isEn } = useLocale()

// Use pre-defined translation constants instead of inline objects
// to reduce memory overhead and avoid unnecessary reactivity tracking
const copy = computed(() => isEn.value ? QUIZ_TRANSLATIONS.en : QUIZ_TRANSLATIONS.zh)
