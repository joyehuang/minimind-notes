...
description: 通过对照实验理解残差连接为什么能保留信息、改善梯度流，并帮助深层 Transformer 稳定训练。
keywords: 残差连接, Residual Connection, 梯度流, Transformer, 深层网络
---
...
- [teaching.md](./teaching.md)：Why / What / How 完整讲解
- [code_guide.md](./code_guide.md)：MiniMind 源码逐行导读
