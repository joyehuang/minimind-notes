---
title: Transformer Block（Transformer 块）模块 | minimind从零理解llm训练
description: 将 RMSNorm、Attention、FeedForward 和残差连接组装为完整的 MiniMind Transformer Block。
keywords: Transformer Block, Decoder Block, Pre-Norm, MiniMind架构
---
...
- [teaching.md](./teaching.md)：组件分工、顺序和数据流
- [code_guide.md](./code_guide.md)：`MiniMindBlock` 与模型堆叠源码
- [quiz.md](./quiz.md)：交互式自测与综合题
